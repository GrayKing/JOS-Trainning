...
umain(int argc, char **argv)
{
  ...
  80005b:	e8 05 01 00 00       	call   800165 <cprintf>
}
  800060:	c9                   	leave  
  800061:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800070:	e8 f0 0f 00 00       	call   801065 <sys_getenvid>
...
exit(void)
{
  ...
  8000bb:	e8 53 0f 00 00       	call   801013 <sys_env_destroy>
}
  8000c0:	c9                   	leave  
  8000c1:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000ef:	e8 e2 0e 00 00       	call   800fd6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800140:	e8 aa 02 00 00       	call   8003ef <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800158:	e8 79 0e 00 00       	call   800fd6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 b8 15 80 00 	movsbl 0x8015b8(%eax),%eax
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800356:	0f be 80 b8 15 80 00 	movsbl 0x8015b8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800474:	ff 24 8d 80 16 80 00 	jmp    *0x801680(,%ecx,4)
  ...
  800540:	c7 44 24 08 d9 15 80 	movl   $0x8015d9,0x8(%esp)
  800547:	00 
  ...
  800572:	b8 c9 15 80 00       	mov    $0x8015c9,%eax
...
cvprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80085e:	ff 24 8d d8 17 80 00 	jmp    *0x8017d8(,%ecx,4)
  ...
  8008f7:	8b 14 85 40 19 80 00 	mov    0x801940(,%eax,4),%edx
  8008fe:	85 d2                	test   %edx,%edx
  800900:	75 23                	jne    800925 <cvprintfmt+0x162>
				printfmt( putch, putdat, "error %d", err);
  800902:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800906:	c7 44 24 08 d0 15 80 	movl   $0x8015d0,0x8(%esp)
  80090d:	00 
  ...
  800929:	c7 44 24 08 d9 15 80 	movl   $0x8015d9,0x8(%esp)
  800930:	00 
  ...
  80095b:	b8 c9 15 80 00       	mov    $0x8015c9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  801040:	00 
  801041:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  801048:	00 
  801049:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801050:	00 
  801051:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8010d2:	00 
  8010d3:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  8010da:	00 
  8010db:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8010e2:	00 
  8010e3:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  801125:	00 
  801126:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  80112d:	00 
  80112e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801135:	00 
  801136:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  801178:	00 
  801179:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  801180:	00 
  801181:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801188:	00 
  801189:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8011cb:	00 
  8011cc:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  8011d3:	00 
  8011d4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8011db:	00 
  8011dc:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80121e:	00 
  80121f:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  801226:	00 
  801227:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80122e:	00 
  80122f:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  801293:	00 
  801294:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  80129b:	00 
  80129c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012a3:	00 
  8012a4:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8012e4:	c7 04 24 94 19 80 00 	movl   $0x801994,(%esp)
  8012eb:	e8 75 ee ff ff       	call   800165 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8012f0:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8012f4:	8b 45 10             	mov    0x10(%ebp),%eax
  8012f7:	89 04 24             	mov    %eax,(%esp)
  8012fa:	e8 05 ee ff ff       	call   800104 <vcprintf>
	cprintf("\n");
  8012ff:	c7 04 24 ac 15 80 00 	movl   $0x8015ac,(%esp)
  801306:	e8 5a ee ff ff       	call   800165 <cprintf>
