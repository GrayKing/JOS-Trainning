...
sys_env_destroy(envid_t envid)
{
  ...
  800115:	00 
  800116:	c7 44 24 08 aa 15 80 	movl   $0x8015aa,0x8(%esp)
  80011d:	00 
  80011e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800125:	00 
  800126:	c7 04 24 c7 15 80 00 	movl   $0x8015c7,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a7:	00 
  8001a8:	c7 44 24 08 aa 15 80 	movl   $0x8015aa,0x8(%esp)
  8001af:	00 
  8001b0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b7:	00 
  8001b8:	c7 04 24 c7 15 80 00 	movl   $0x8015c7,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fa:	00 
  8001fb:	c7 44 24 08 aa 15 80 	movl   $0x8015aa,0x8(%esp)
  800202:	00 
  800203:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020a:	00 
  80020b:	c7 04 24 c7 15 80 00 	movl   $0x8015c7,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024d:	00 
  80024e:	c7 44 24 08 aa 15 80 	movl   $0x8015aa,0x8(%esp)
  800255:	00 
  800256:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80025d:	00 
  80025e:	c7 04 24 c7 15 80 00 	movl   $0x8015c7,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a0:	00 
  8002a1:	c7 44 24 08 aa 15 80 	movl   $0x8015aa,0x8(%esp)
  8002a8:	00 
  8002a9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b0:	00 
  8002b1:	c7 04 24 c7 15 80 00 	movl   $0x8015c7,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002f3:	00 
  8002f4:	c7 44 24 08 aa 15 80 	movl   $0x8015aa,0x8(%esp)
  8002fb:	00 
  8002fc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800303:	00 
  800304:	c7 04 24 c7 15 80 00 	movl   $0x8015c7,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800368:	00 
  800369:	c7 44 24 08 aa 15 80 	movl   $0x8015aa,0x8(%esp)
  800370:	00 
  800371:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800378:	00 
  800379:	c7 04 24 c7 15 80 00 	movl   $0x8015c7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003b9:	c7 04 24 d8 15 80 00 	movl   $0x8015d8,(%esp)
  ...
  8003cf:	e8 51 00 00 00       	call   800425 <vcprintf>
	cprintf("\n");
  8003d4:	c7 04 24 fc 15 80 00 	movl   $0x8015fc,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800461:	e8 a9 02 00 00       	call   80070f <vprintfmt>
	sys_cputs(b.buf, b.idx);
