	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 c8 15 80 00 	movsbl 0x8015c8(%eax),%eax
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800346:	0f be 80 c8 15 80 00 	movsbl 0x8015c8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800464:	ff 24 8d 80 16 80 00 	jmp    *0x801680(,%ecx,4)
  ...
  800530:	c7 44 24 08 e9 15 80 	movl   $0x8015e9,0x8(%esp)
  800537:	00 
  ...
  800562:	b8 d9 15 80 00       	mov    $0x8015d9,%eax
...
cvprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80084e:	ff 24 8d d8 17 80 00 	jmp    *0x8017d8(,%ecx,4)
  ...
  8008e7:	8b 14 85 40 19 80 00 	mov    0x801940(,%eax,4),%edx
  8008ee:	85 d2                	test   %edx,%edx
  8008f0:	75 23                	jne    800915 <cvprintfmt+0x162>
				printfmt( putch, putdat, "error %d", err);
  8008f2:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8008f6:	c7 44 24 08 e0 15 80 	movl   $0x8015e0,0x8(%esp)
  8008fd:	00 
  ...
  800919:	c7 44 24 08 e9 15 80 	movl   $0x8015e9,0x8(%esp)
  800920:	00 
  ...
  80094b:	b8 d9 15 80 00       	mov    $0x8015d9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  801030:	00 
  801031:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  801038:	00 
  801039:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801040:	00 
  801041:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8010c2:	00 
  8010c3:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  8010ca:	00 
  8010cb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8010d2:	00 
  8010d3:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  801115:	00 
  801116:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  80111d:	00 
  80111e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801125:	00 
  801126:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  801168:	00 
  801169:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  801170:	00 
  801171:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801178:	00 
  801179:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8011bb:	00 
  8011bc:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  8011c3:	00 
  8011c4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8011cb:	00 
  8011cc:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80120e:	00 
  80120f:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  801216:	00 
  801217:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80121e:	00 
  80121f:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  801283:	00 
  801284:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  80128b:	00 
  80128c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801293:	00 
  801294:	c7 04 24 85 19 80 00 	movl   $0x801985,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8012d4:	c7 04 24 94 19 80 00 	movl   $0x801994,(%esp)
  ...
  8012ea:	e8 03 ee ff ff       	call   8000f2 <vcprintf>
	cprintf("\n");
  8012ef:	c7 04 24 bc 15 80 00 	movl   $0x8015bc,(%esp)
