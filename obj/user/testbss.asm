...
umain(int argc, char **argv)
{
  ...
  800039:	c7 04 24 40 16 80 00 	movl   $0x801640,(%esp)
  ...
  800058:	c7 44 24 08 bb 16 80 	movl   $0x8016bb,0x8(%esp)
  80005f:	00 
  800060:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  800067:	00 
  800068:	c7 04 24 d8 16 80 00 	movl   $0x8016d8,(%esp)
...
umain(int argc, char **argv)
{
  ...
  8000a6:	c7 44 24 08 60 16 80 	movl   $0x801660,0x8(%esp)
  8000ad:	00 
  8000ae:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8000b5:	00 
  8000b6:	c7 04 24 d8 16 80 00 	movl   $0x8016d8,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  80010c:	e8 44 10 00 00       	call   801155 <sys_getenvid>
...
exit(void)
{
  ...
  800153:	e8 ab 0f 00 00       	call   801103 <sys_env_destroy>
}
  800158:	c9                   	leave  
  800159:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80016b:	e8 e5 0f 00 00       	call   801155 <sys_getenvid>
  ...
  800186:	c7 04 24 08 17 80 00 	movl   $0x801708,(%esp)
  ...
  80019c:	e8 51 00 00 00       	call   8001f2 <vcprintf>
	cprintf("\n");
  8001a1:	c7 04 24 d6 16 80 00 	movl   $0x8016d6,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8001dd:	e8 e4 0e 00 00       	call   8010c6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80022e:	e8 ac 02 00 00       	call   8004df <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800246:	e8 7b 0e 00 00       	call   8010c6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002df:	e8 cc 10 00 00       	call   8013b0 <__udivdi3>
  ...
  80033f:	e8 9c 11 00 00       	call   8014e0 <__umoddi3>
  800344:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800348:	0f be 80 2c 17 80 00 	movsbl 0x80172c(%eax),%eax
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8003df:	e8 cc 0f 00 00       	call   8013b0 <__udivdi3>
  ...
  80043d:	e8 9e 10 00 00       	call   8014e0 <__umoddi3>
  800442:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800446:	0f be 80 2c 17 80 00 	movsbl 0x80172c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800564:	ff 24 8d 00 18 80 00 	jmp    *0x801800(,%ecx,4)
  ...
  800630:	c7 44 24 08 4d 17 80 	movl   $0x80174d,0x8(%esp)
  800637:	00 
  ...
  800662:	b8 3d 17 80 00       	mov    $0x80173d,%eax
...
cvprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80094e:	ff 24 8d 58 19 80 00 	jmp    *0x801958(,%ecx,4)
  ...
  8009e7:	8b 14 85 c0 1a 80 00 	mov    0x801ac0(,%eax,4),%edx
  8009ee:	85 d2                	test   %edx,%edx
  8009f0:	75 23                	jne    800a15 <cvprintfmt+0x162>
				printfmt( putch, putdat, "error %d", err);
  8009f2:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8009f6:	c7 44 24 08 44 17 80 	movl   $0x801744,0x8(%esp)
  8009fd:	00 
  ...
  800a19:	c7 44 24 08 4d 17 80 	movl   $0x80174d,0x8(%esp)
  800a20:	00 
  ...
  800a4b:	b8 3d 17 80 00       	mov    $0x80173d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  801130:	00 
  801131:	c7 44 24 08 e8 1a 80 	movl   $0x801ae8,0x8(%esp)
  801138:	00 
  801139:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801140:	00 
  801141:	c7 04 24 05 1b 80 00 	movl   $0x801b05,(%esp)
  801148:	e8 0d f0 ff ff       	call   80015a <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8011c2:	00 
  8011c3:	c7 44 24 08 e8 1a 80 	movl   $0x801ae8,0x8(%esp)
  8011ca:	00 
  8011cb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8011d2:	00 
  8011d3:	c7 04 24 05 1b 80 00 	movl   $0x801b05,(%esp)
  8011da:	e8 7b ef ff ff       	call   80015a <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  801215:	00 
  801216:	c7 44 24 08 e8 1a 80 	movl   $0x801ae8,0x8(%esp)
  80121d:	00 
  80121e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801225:	00 
  801226:	c7 04 24 05 1b 80 00 	movl   $0x801b05,(%esp)
  80122d:	e8 28 ef ff ff       	call   80015a <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  801268:	00 
  801269:	c7 44 24 08 e8 1a 80 	movl   $0x801ae8,0x8(%esp)
  801270:	00 
  801271:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801278:	00 
  801279:	c7 04 24 05 1b 80 00 	movl   $0x801b05,(%esp)
  801280:	e8 d5 ee ff ff       	call   80015a <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8012bb:	00 
  8012bc:	c7 44 24 08 e8 1a 80 	movl   $0x801ae8,0x8(%esp)
  8012c3:	00 
  8012c4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012cb:	00 
  8012cc:	c7 04 24 05 1b 80 00 	movl   $0x801b05,(%esp)
  8012d3:	e8 82 ee ff ff       	call   80015a <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80130e:	00 
  80130f:	c7 44 24 08 e8 1a 80 	movl   $0x801ae8,0x8(%esp)
  801316:	00 
  801317:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80131e:	00 
  80131f:	c7 04 24 05 1b 80 00 	movl   $0x801b05,(%esp)
  801326:	e8 2f ee ff ff       	call   80015a <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  801383:	00 
  801384:	c7 44 24 08 e8 1a 80 	movl   $0x801ae8,0x8(%esp)
  80138b:	00 
  80138c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801393:	00 
  801394:	c7 04 24 05 1b 80 00 	movl   $0x801b05,(%esp)
  80139b:	e8 ba ed ff ff       	call   80015a <_panic>
